        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Create professional invoices in 30 seconds, get paid faster, and improve your cash
              flow with Invoice App's complete invoicing solution.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              >
                <Play className="mr-2 size-5" /> View Pricing Plans
              </Button>
            </div>
            ...
            <div className="mt-8 flex items-center gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>freelancers trust us</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Invoice App dashboard showing professional invoice templates and payment tracking"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Invoice Speed</p>
              <p className="text-sm">
                <span className="font-semibold text-primary">30</span> seconds
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Collection Rate</p>
              <p className="text-sm">
                <span className="font-semibold text-primary">+40%</span> increase
              </p>
            </div>
          </div>
        </div>
